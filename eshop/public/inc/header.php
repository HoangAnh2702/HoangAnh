...
<head>
	...
	<!-- Title Tag  -->
	<title>ECom - Dễ dàng mua sắm</title>
	<!-- Favicon -->
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-4 col-md-12 col-12">
						...
						<div class="top-left">
							<ul class="list-main">
								<li><i class="ti-headphone-alt"></i>0334884378</li>
								<li><i class="ti-email"></i>1911547491@nttu.edu.vn</li>
							</ul>
						</div>
						<!--/ End Top Left -->
					</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-2 col-md-2 col-12">
						<!-- Logo -->
						<div class="logo">
							<a href="index.html"><img src="public/images/logo1.png" alt="logo"></a>
						</div>
						<!--/ End Logo -->
						<!-- Search Form -->
					...
					<div class="col-lg-8 col-md-7 col-12">
						<div class="search-bar-top">
							<div class="search-bar">
								<input name="search" id="search" placeholder="Tìm sản phẩm...." type="search">
							</div>
						</div>
					</div>
